...
def run_over_fc_binary_annotation(option=3):
    ...
    if option == 0:
        ...
        tr_pretrained_model_label = "dmis-lab/biobert-v1.1"
    ...
    for seed_val_2 in [
        ...
        tr_ffnn(for_task_label="fc",
                ...
                annotate_test_instances=True,          # for paper dataset results
                annotate_new_instances=False,
                annotate_external_instances=True,      # for recovery dataset results
