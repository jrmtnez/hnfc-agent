...
if __name__ == "__main__":
    ...
    run_fc_grid_search(fc_transformer=False,
                       fc_ffnn=False,
                       fc_ensemble_transformer_ffnn=True)
