from agent.data.entities.config import EXTERNAL_ITEM_FILTER, EXTERNAL_LABEL
...
def get_datasets(pretrained_model, max_lenght, binary_classifier=False,
    ...
    return get_datasets_from_filter(pretrained_model, EXTERNAL_ITEM_FILTER, EXTERNAL_LABEL, max_lenght,
