...
from agent.classifiers.data.liwc_management import export_item_data_for_liwc_features, get_item_liwc_features
    ...
    for n_estimators in [4, 8, 10, 12, 15, 20, 100, 200, 500, 1000]:
        for seed_val in [0, 12, 33, 42, 54, 63, 70, 79, 85, 96]:
            tree_classifier(for_task_label="fd",
                            ...
                            get_data_function=get_item_liwc_features,
                            dev_dataset=False,
...
if __name__ == "__main__":
    ...
    # export_item_data_for_liwc_features()

    # get_item_liwc_features(binary_classifier=True, dev_dataset=True)
